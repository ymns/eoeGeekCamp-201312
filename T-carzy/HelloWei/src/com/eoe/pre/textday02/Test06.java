...
public class Test06 {
	public static void main(String[] args){
		...
		int intValue=Integer.parseInt("200313");
		...
		System.out.println("16转换为二进制数："+binaryValue);
		...
		long longValue=Long.parseLong("900000000");
		...
		System.out.println("float的取值范围："+Float.MIN_NORMAL+"~"+Float.MAX_VALUE );
		float floatValue=Long.parseLong("2222222");
		System.out.println(floatValue);
		hexValue=Float.toHexString(16);
		System.out.println("16转换为16进制数："+hexValue);
		//Double类的常用方法和常量
		System.out.println("double的数据总数："+Math.pow(2,64));
		System.out.println("double的取值范围："+Double.MIN_NORMAL+"~"+Double.MAX_VALUE);
		double doubleValue=Long.parseLong("200000");
